...
void setup() {
  ...
  http.on("/", []() { http.sendHeader("Cache-Control", "no-store"); http.send(200, "text/plain", "ESP motion controller online. Open the computer-hosted UI at http://127.0.0.1:8080."); });
